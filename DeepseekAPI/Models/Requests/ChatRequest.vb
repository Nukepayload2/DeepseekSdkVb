...
Namespace Models
    ...
    Public Class ChatRequest
        ...
        ''' 思考模式配置。启用后模型会进行深度推理。
        ''' </summary>
        Public Property Thinking As ThinkingConfig

        ''' <summary>
        ''' 推理强度。可选值："high"、"max"。普通请求默认 "high"，Agent 类请求自动设为 "max"。
        ''' </summary>
        Public Property ReasoningEffort As String

        ''' <summary>
        ''' 自定义用户标识，用于内容安全和 KVCache 缓存隔离。
        ''' </summary>
    ...
    Public Class FunctionMetadata
        ...
        ''' <summary>
        ''' 是否启用严格 schema 模式（Beta）。默认为 false。
        ''' </summary>
    ...
    Public Class ModelNames
        ...
        ''' <summary>
        ''' DeepSeek V4 Flash 模型 ID "deepseek-v4-flash"
        ''' </summary>
        Public Shared ReadOnly Property V4Flash As String = "deepseek-v4-flash"

        ''' <summary>
        ''' DeepSeek V4 Pro 模型 ID "deepseek-v4-pro"
        ''' </summary>
        Public Shared ReadOnly Property V4Pro As String = "deepseek-v4-pro"
    End Class
    ...
    ''' 推理强度常量
    ''' </summary>
    Public Class ReasoningEffortLevels
        ''' <summary>
        ''' 高强度推理（普通请求默认值）
        ''' </summary>
        Public Shared ReadOnly Property High As String = "high"

        ''' <summary>
        ''' 最高强度推理（Agent 类请求自动设为该值）
        ''' </summary>
        Public Shared ReadOnly Property Max As String = "max"
    End Class
End Namespace
